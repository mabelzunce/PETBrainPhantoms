...
bigbrainFile = [dataPath 'full_cls_400um_2009b_sym.nii.gz'];
...
niftiwrite(fdgPhantomForNifti, [dataPath 'fdg_pet_phantom_uptake'], info, 'Compressed', 1)
...
niftiwrite(muMapPhantomForNifti, [dataPath 'fdg_pet_phantom_umap'], info, 'Compressed', 1)
...
niftiwrite(ctPhantomForNifti, [dataPath 'fdg_pet_phantom_ct'], info, 'Compressed', 1)
...
niftiwrite(mriPhantomForNifti, [dataPath 'fdg_pet_phantom_mri'], info, 'Compressed', 1)
